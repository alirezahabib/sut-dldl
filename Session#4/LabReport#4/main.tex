...
\newcommand{\school}{
گزارش کار چهارم آزمایشگاه مدارهای منطقی
}
...
\newpage
\chapter{مقدمه}
هدف از این آزمایش، ساخت یک مدار کنترل‌کننده ساده با کمک
\lr{ASM Chart}
است.
موضوع انتخابی ما مدار کنترل‌کننده و تایمر یک ماشین لباس‌شویی ساده است.
